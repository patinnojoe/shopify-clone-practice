...
import { AppHeader, AppSidebar, ChartComp, WaterfallChart } from './UI';
        ...
        <main className="page-inner">
          <section className="d-flex flex-column gap-4 mb-5">
            <div className="d-flex flex-column gap-2">
              ...
              {/* sub buttons */}
              <div className="discount-header mt-3">
                ...
                <div className="d-flex gap-3 align-items-center">
                  ...
                  <button className="shopify-primary-border-btn bg-white">Costomize</button>
                </div>
              </div>
            </div>
