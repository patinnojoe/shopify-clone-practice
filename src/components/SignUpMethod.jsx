...
import { AppleSVg, FacebookSvg, GoogleSvg } from '../assets';
        ...
        <div className="d-flex flex-column  flex-grow-1 ">
          <div className="flex-grow-1 d-flex flex-column">
            ...
            <div className="d-flex flex-column  mt-4 mb-4">
              <p className="fw-semi-bold fnt-25">Create a Shopify ID</p>
              <span className="fnt-14">One last step before starting your free trial.</span>
            </div>
